...
<head>
  ...
  <!-- Plugin CSS -->
  <link href="{{ asset('public/frontEnd/')}}/vendor/magnific-popup/magnific-popup.css" rel="stylesheet">

  <!-- Theme CSS - Includes Bootstrap -->
  <link href="{{ asset('public/frontEnd/')}}/css/creative.min.css" rel="stylesheet">
...
<body id="page-top">
  ...
  <script src="{{ asset('public/frontEnd/')}}/js/creative.min.js"></script>
